...
use crate::rules::{
    ...
    perflint, pycodestyle, pyflakes, pygrep_hooks, pylint, pyupgrade, refurb, ruff, tinybird,
    tryceratops,
};
...
pub(crate) fn statement(stmt: &Stmt, checker: &mut Checker) {
    match stmt {
        ...
        Stmt::ClassDef(
            ...
            if checker.enabled(Rule::TinybirdDummy) {
                tinybird::rules::dummy(checker, class_def)
            }
